...
require_dependency base_url + '/lib/redmine_issues_tree/hook_listener'
...
require base_url + '/lib/redmine_issues_tree/hook_listener'
require base_url + '/lib/redmine_issues_tree/issues_controller_patch'
require base_url + '/lib/redmine_issues_tree/issues_helper_patch'
